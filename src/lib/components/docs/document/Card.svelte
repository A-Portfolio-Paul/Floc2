<script>
	...
	$:dragZoneStyle = $currentView[0].cardMap[node.id].cols ? 'w-full p-1  rounded-t-md flex flex-row level' +colorShade:'w-full p-1  rounded-t-md flex flex-col level' +colorShade
